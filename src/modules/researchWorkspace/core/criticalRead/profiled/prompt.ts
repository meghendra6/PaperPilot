...
function buildProfiledCriticalReadPrompt(
  params: PaperPromptInput & {
    profile: ReturnType<typeof import("./profiles").getCriticalReadProfile>;
  },
) {
...
{"executiveSummary":"...","strengths":["..."],"checks":[{"checkId":"...","status":"supported|partial|unsupported|not_applicable|unclear","severity":"none|minor|major|critical","finding":"...","implication":"...","evidence":[${JSON.stringify(evidenceExample)}],"confidence":0.0}],"discriminatingExperiments":[{"hypothesis":"...","experiment":"...","expectedOutcomes":["..."],"evidence":[${JSON.stringify(evidenceExample)}]}],"residualUncertainty":["..."]}
