...
function syncPreviewChangeLabels(preview: ResearchWorkspaceZoteroSyncPreview) {
...
function renderZoteroSyncPreview(
  doc: Document,
  root: HTMLElement,
  details: ResearchWorkspaceProjectDetails,
...
function renderZoteroSyncTargets(
  doc: Document,
  root: HTMLElement,
  details: ResearchWorkspaceProjectDetails,
...
function renderSafeZoteroSyncPanel(
  doc: Document,
  root: HTMLElement,
  details: ResearchWorkspaceProjectDetails,
