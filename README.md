...
- model selection across the current Codex CLI catalog (`gpt-5.6-sol` default, plus `gpt-5.6-terra`, `gpt-5.6-luna`, `gpt-5.5`, and earlier), with per-model reasoning effort options up to `max`/`ultra` where supported
