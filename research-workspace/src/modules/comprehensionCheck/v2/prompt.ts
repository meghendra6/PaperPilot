...
exports.buildMasteryBlueprintPrompt = buildMasteryBlueprintPrompt;
exports.buildMasteryQuestionPrompt = buildMasteryQuestionPrompt;
exports.buildMasteryGradePrompt = buildMasteryGradePrompt;
...
function compactAttemptHistory(session, conceptId) {
    const history = session.attempts
        ...
        misconceptionSeverities: attempt.grade.misconceptions.map((misconception) => misconception.severity),
    }));
