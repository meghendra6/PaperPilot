...
exports.tokenizeForRetrieval = void 0;
exports.tokenizeHybrid = tokenizeHybrid;
exports.tokenizeHybridOccurrences = tokenizeHybridOccurrences;
exports.queryPhrases = queryPhrases;
const ALIASES = {
...
const STOPWORDS = new Set([
    ...
    "및", "또는", "이", "그", "저", "것", "수", "를", "을", "에", "의", "가", "은", "는", "와", "과", "로", "으로", "에서", "한다", "했다",
]);
...
function tokenizeHybridOccurrences(text, expandAliases = true) {
    ...
    const raw = normalized.match(/[a-z0-9]+(?:[-_.][a-z0-9]+)*|[가-힣]+|[α-ωΑ-Ω]+/g) ?? [];
    const tokens = [];
...
exports.tokenizeForRetrieval = tokenizeHybrid;
